...
public class JSONReadPI5J1V {
	...
	public static void main (String[] args) {
		...
		try (FileReader reader = new FileReader("orarendPI5J1V.json")){
			...
			//ROOT, majd óra lista lekérés.
			JSONObject root = (JSONObject) jsonObject.get("PI5J1V_orarend");
			JSONArray lessons = (JSONArray)root.get("ora");
			
			//óra adatok leírása
			System.out.println("PI5J1V Órarend 2025 ősz:\n");
